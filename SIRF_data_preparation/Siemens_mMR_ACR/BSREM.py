...
dataset = 'Siemens_mMR_ACR'
outdir = "./output/BSREM_" + dataset
data = get_data(srcdir="./data/" + dataset + "/final/", outdir=outdir)
num_subsets = 7
...
algo.run(15000, callbacks=[MetricsWithTimeout(seconds=3600*30, outdir=outdir, transverse_slice=99)])
