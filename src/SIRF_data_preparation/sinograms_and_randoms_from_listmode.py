...
Options:
  ...
  -o <outp>, --outp=<outp>     path to output data files [default: .]
  -l <list>, --list=<list>     listmode file [default: 20170809_NEMA_60min_UCL.l.hdr]
...
def main():
    ...
    sino_file = os.path.join(outp, sino_file)
    ...
    rand_file = os.path.join(outp, rand_file)
